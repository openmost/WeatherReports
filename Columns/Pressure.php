 ...
 */
class Pressure extends VisitDimension
{
    /**
    ...
    protected $acceptValues = 'Value as a number';
    ...
    {
        $paramValue = Common::getRequestVar('weather_pressure', '', 'string', $request->getParams());
        if (!empty($paramValue)) {
            return $paramValue;
        }
