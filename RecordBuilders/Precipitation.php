...
class Precipitation extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::PRECIPITATION_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::PRECIPITATION_DIMENSION]);
        ...
        return [Archiver::PRECIPITATION_RECORD_NAME => $record];
    }
}
