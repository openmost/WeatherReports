...
class WindDirection extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::WIND_DIRECTION_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::WIND_DIRECTION_DIMENSION]);
        ...
        return [Archiver::WIND_DIRECTION_RECORD_NAME => $record];
    }
}
