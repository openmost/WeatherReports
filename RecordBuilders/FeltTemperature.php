...
class FeltTemperature extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::FELT_TEMPERATURE_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::FELT_TEMPERATURE_DIMENSION]);
        ...
        return [Archiver::FELT_TEMPERATURE_RECORD_NAME => $record];
    }
}
