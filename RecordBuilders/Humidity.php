...
class Humidity extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::HUMIDITY_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::HUMIDITY_DIMENSION]);
        ...
        return [Archiver::HUMIDITY_RECORD_NAME => $record];
    }
}
