...
class Visibility extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::VISIBILITY_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::VISIBILITY_DIMENSION]);
        ...
        return [Archiver::VISIBILITY_RECORD_NAME => $record];
    }
}
