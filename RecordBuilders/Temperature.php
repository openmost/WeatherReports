...
class Temperature extends RecordBuilder
{
    ...
    {
        return [
            Record::make(Record::TYPE_BLOB, Archiver::TEMPERATURE_RECORD_NAME),
        ];
    }
    ...
    protected function aggregate(ArchiveProcessor $archiveProcessor): array
    {
        ...
        $cursor = $archiveProcessor->getLogAggregator()->queryVisitsByDimension(['label' => Archiver::TEMPERATURE_DIMENSION]);
        ...
        return [Archiver::TEMPERATURE_RECORD_NAME => $record];
    }
}
